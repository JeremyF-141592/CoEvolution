...
from Objects.Environments.DistanceBenchmark import print_points
import pickle

Configuration.make()

envs_file = "../temp/Test_Environments.pickle"
poet_file = "../temp/POET_ag.pickle"
nnsga_file = "../temp/NNSGA_ag.pickle"
...
for env in envs:
    ...
    plt.plot(nnsga_ags[0].value[0], nnsga_ags[0].value[1], "o", color="cyan", label="NNSGA agents")
    for ag in nnsga_ags[1:]:
        plt.plot(ag.value[0], ag.value[1], "o",color="cyan")
