...
sns.kdeplot(np.array(Env_solvability_POET), color="deepskyblue")
plt.axvline(np.median(Env_solvability_POET), linestyle="--", color="deepskyblue")

sns.kdeplot(np.array(Env_solvability_NNSGA), color="orange")
plt.axvline(np.median(Env_solvability_NNSGA), linestyle="--", color="orange")
plt.show()
sns.kdeplot(np.array(Ag_generalist_POET), color="deepskyblue")
plt.axvline(np.median(Ag_generalist_POET), linestyle="--", color="deepskyblue")

sns.kdeplot(np.array(Ag_generalist_NNSGA), color="orange")
